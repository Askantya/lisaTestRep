...
// const matrixArray = (firstNumber: number, secondNumber: number): void => {
...
// const shiftingArrayElements = (countOfElements: number): void => {
...
// const sortListOfStudents = (numberOfCourse: number): any => {
